...
// in run_bus/test/features/domain/usecase/version/has_upades_updades_use_case_test.dart.
...
/// A class which mocks [IVersionDatabaseRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockIVersionDatabaseRepository extends _i1.Mock
    implements _i3.IVersionDatabaseRepository {
  MockIVersionDatabaseRepository() {
    _i1.throwOnMissingStub(this);
  }
